...
//        this.getContentPane().setBackground(new Color(1.0f,1.0f,1.0f,0.0f));
        ...
        try {
            ...
            if(rs.next()){
                if(user.equalsIgnoreCase(rs.getString("username"))&&pass.equalsIgnoreCase(rs.getString("password"))){
                    ...
                    FormUtama.user.setText(rs.getString("username"));
                    dispose();
                    frm.setVisible(true);
    ...
    private void initComponents() {
        ...
        txUser.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(kGradientPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 281, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(kGradientPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
        );
