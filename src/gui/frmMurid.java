 ...
 * @author User
 */
public class frmMurid extends javax.swing.JDialog {
    murid pl;
    utama ut;
    /**
     * Creates new form frmMurid
     */
    public frmMurid(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ut = new utama();
    ...
    private void initComponents() {
        ...
        txnomor1 = new javax.swing.JTextField();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "DATA MURID", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        txnomor1.setEditable(false);
        txnomor1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txnomor1ActionPerformed(evt);
            }
        });
        txnomor1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txnomor1KeyTyped(evt);
            }
        });
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(txnomor1, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel5)
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txnomor.setText(jTable1.getValueAt(row, 4).toString());
        txnomor1.setText(jTable1.getValueAt(row, 3).toString());
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if(edit==true){
            ...
            String nomor1 = txnomor1.getText();
            edit=false;
            try {
                pl.edit(idpelanggan, nama, alamat,nomor1, nomor);
            ...
            try {
                pl.simpan(idpelanggan, nama, alamat, nomor1, nomor);
    ...
    private void txnomor1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txnomor1KeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_txnomor1KeyTyped

    private void txnomor1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txnomor1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txnomor1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmMurid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmMurid dialog = new frmMurid(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField txnomor1;
